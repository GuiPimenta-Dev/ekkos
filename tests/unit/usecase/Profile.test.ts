...
test("It should be able to match all profiles that is near you 15km away", async () => {
  profileBuilder.createProfile().withCoordinates(-22.90045, -43.11867);
  profileBuilder.createProfile().withCoordinates(-22.93749, -43.17597);
  profileBuilder.createProfile().withCoordinates(-22.8219, -43.03092);
  const profile = profileBuilder.createProfile().withCoordinates(-22.90463, -43.1053);
...
test("It should return distance 0 if profile is in same place", async () => {
  profileBuilder.createProfile().withCoordinates(-22.90463, -43.1053);
  const profile = profileBuilder.createProfile().withCoordinates(-22.90463, -43.1053);
